...
let carModels = [];
let carModelsSorted = inventory.sort((a , b) => a.car_model.localeCompare(b.car_model));
...
// în consolă.
let BMW = inventory.filter(item => item.car_make === "BMW");
console.log(BMW);
let Audi = inventory.filter(item => item.car_make === "Audi");
console.log(Audi);
